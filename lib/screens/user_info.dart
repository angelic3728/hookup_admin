            ...
            PopupMenuButton(itemBuilder: (ct) {
              return [
                PopupMenuItem(
                  ...
                  child: InkWell(
                    child: Text(
                        "${widget.userIndex.isBlocked ? "Unblock user" : "Block user"}"),
                    onTap: () async {
                      Navigator.pop(ct);
                      showDialog(
                        context: context,
                          ...
                          return BeautifulAlertDialog(
                              ...
                              onYesTap: () async {
                                await Firestore.instance
                                  ...
                                  snackbar(
                                      "${!widget.userIndex.isBlocked ? "Blocked" : "Unblocked"}",
                                      _scaffoldKey);
                ...
                Expanded(
                  ...
                  children: [
                    ...
                    ListTile(
                        ...
                        subtitle: Text(
                            widget.userIndex.editInfo["job_title"] != null
                    ...
                    ListTile(
                        ...
                        title: Text("Company"),
                        subtitle: Text(
                            widget.userIndex.editInfo["company"] != null
                    ...
                    ListTile(
                        ...
                        subtitle: Text(
                            widget.userIndex.editInfo["living_in"] != null
